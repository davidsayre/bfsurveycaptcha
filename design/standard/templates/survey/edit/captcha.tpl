<h2 class="attributetype">{"Captcha"|i18n('survey')}</h2>
...
<div class="block">
   ...
   <label>
   <input type="checkbox" name="{$prefix_attribute}_ezsurvey_question_{$question.id}_mandatory_{$attribute_id}" value="1" {if $question.mandatory}checked{/if} />
